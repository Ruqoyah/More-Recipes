...
import { validateRecipesId, validateUsersId, checkRecipeInput, checkUserInput, validateUsers, validateLoginUser, checkReviewInput } from '../middleware/validation';
...
app.post('/api/users/:userId/recipes', validateUsersId, favoriteRecipesController.favoriteRecipe);
