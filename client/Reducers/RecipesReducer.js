import {
  ...
  EDIT_RECIPE, SAVE_RECIPE_IMAGE, VIEW_UPVOTE_RECIPE, VIEW_DOWNVOTE_RECIPE, LOAD_MORE_REVIEWS
} from '../Actions/Types';
...
const recipeReducer = (state = INITIAL_STATE, action) => {
  ...
  case GET_USER_RECIPES:
    return { ...state, userRecipe: action.payload.recipes.rows, count: action.payload.recipes.count };
  case EDIT_RECIPE: {
    const newArr = [];
