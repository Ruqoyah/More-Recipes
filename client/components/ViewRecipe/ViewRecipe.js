    ...
    return (
      <div>
        ...
        <div className="view-recipe">
          <div class="container">
            <h2>Strawberry</h2> <hr />
            <img src="images/strawberries and steak.png" className="img-thumbnail" alt="strawberry" width="700" /> <hr />
            <h4>Ingredients</h4>
            <p>Flour, water, pepper and onion</p><hr />
            <h4>Details</h4>
            <p>A fun salad that kids, and just about everyone else, will love. Fruit cocktail, grapes, mandarin
            oranges, whipped topping and mini marshmallows, are stirred together and chilled. Serves eight
            </p>
