    ...
    return (
      <div>
        ...
        <div className="card-deck">
          <div className="card">
            <img className="card-img-top" src="images/strawberries and steak.png"
              alt="strawberries and steak" />
            <div className="card-body">
              <h4 className="card-title">Strawberries and Steak</h4>
              <p className="card-text">Fresh greens are tossed with strawberries, toasted pecans,
                and blue cheese. A lively dressing unites all
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">The crust is made from cookie dough and cooked until golden brown.
                The topping is a whipped topping and a swirl of fresh fruit slices -kiwi, strawberries
                or peaches.</p>
